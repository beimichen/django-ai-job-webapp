...
ALLOWED_HOSTS = ['www.jobassistant.com', 'YOUR_HOST', 'localhost', local_ip, '54.200.144.65']
...
SECURE_SSL_REDIRECT = False  # env.bool('DJANGO_SECURE_SSL_REDIRECT', default=True)
...
SECURE_HSTS_INCLUDE_SUBDOMAINS = False  # env.bool('DJANGO_SECURE_HSTS_INCLUDE_SUBDOMAINS', default=True)
# https://docs.djangoproject.com/en/dev/ref/settings/#secure-hsts-preload
SECURE_HSTS_PRELOAD = False  # env.bool('DJANGO_SECURE_HSTS_PRELOAD', default=True)
# https://docs.djangoproject.com/en/dev/ref/middleware/#x-content-type-options-nosniff
SECURE_CONTENT_TYPE_NOSNIFF = False  # env.bool('DJANGO_SECURE_CONTENT_TYPE_NOSNIFF', default=True)
...
MEDIA_URL = "https://d133ose6pbj6kd.cloudfront.net/"  # f'https://{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com/media/'
...
INTERNAL_IPS = [local_ip]

# # GOOGLE ANALYTICS
#
# GOOGLE_ANALYTICS = {
#     'google_analytics_id': 'UA-152890247-1',
# }
#
...
ANYMAIL = {
    ...
    'MAILGUN_SENDER_DOMAIN': 'mg.jobassistant.com' # os.environ['MAILGUN_DOMAIN'] # TODO: register mailgun and set MAILGUN_DOMAIN env var
}
